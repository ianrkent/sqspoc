    ...
    public class ProductPactVerifier
    {
        ...
        public void VerifyAllHealthCheckPacts()
        {
            ...
            pactVerifier
                ...
                .ProviderState("The service is up and running and some dependencies are not available");
            ...
            using (var testServer = TestServer.Create<Startup>()) //NOTE: This is using the Microsoft.Owin.Testing to test host an owin app :)
            {
                ...
                // pactVerifier.Verify("A request for the status", "The service is up and running and some dependencies are not available");
            }
        }
    }
}
